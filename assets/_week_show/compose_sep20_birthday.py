...
OUT = ROOT / "assets/sg-morning-flyer-2026-09-20-robert-reiki-v3.jpg"
SIZE = 1080
FOOTER = 92
...
def main() -> None:
    ...
    f_line = font("Arial Rounded Bold.ttf", 88)
    f_foot = font("Arial Bold.ttf", 26)

    cx = SIZE / 2
    center_text(draw, (cx, 56), "Robert 12 to 5 PM", f_line, white)
    center_text(draw, (cx, 760), "Reiki Share Free", f_line, white)
    center_text(draw, (cx, 850), "3 to 5 PM", f_line, white)
