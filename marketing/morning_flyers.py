...
def build_generation_prompt(
    ...
    *,
    ...
    shared = (
        ...
        "NEVER paint prompt instructions onto the image — forbidden on-image "
        "text includes: EQUAL-WEIGHT, equal weight, put the sun logo here, "
        "put logo here, VARIANT A, VARIANT B, style name labels, art-direction "
        "notes, or any meta/layout directions. Only real event titles, times, "
        "shop pride, website, and phone may appear as readable text. "
